...
export const MOCK_OFERTAS: Oferta[] = [
  {
    ...
    valor: 1200, taxaRetorno: 4.8, prazoDias: 45, parcelasTotal: 6, ciclo: 'Semanal',
  ...
  },
  {
    ...
    valor: 800, taxaRetorno: 7.2, prazoDias: 90, parcelasTotal: 3, ciclo: 'Mensal',
  ...
  },
  {
    ...
    valor: 500, taxaRetorno: 2.1, prazoDias: 15, parcelasTotal: 15, ciclo: 'Diário',
    risco: 'Baixo', tomadorScore: 'A',
  ...
  },
  {
    ...
    valor: 2000, taxaRetorno: 5.5, prazoDias: 60, parcelasTotal: 8, ciclo: 'Semanal',
  ...
  },
  {
    ...
    valor: 350, taxaRetorno: 3.4, prazoDias: 30, parcelasTotal: 1, ciclo: 'Mensal',
    risco: 'Médio', tomadorScore: 'B',
