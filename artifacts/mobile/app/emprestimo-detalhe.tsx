...
const s = StyleSheet.create({
  ...
  heroEyebrow: { fontSize: fontSize.sm, fontFamily: fonts.semibold, letterSpacing: 0.3, color: C.onDarkSoft, marginBottom: 8 },
  ...
  // Dates
  datesRow: { flexDirection: 'row', alignItems: 'center', gap: spacing[3], marginHorizontal: spacing[4], marginBottom: 14, padding: 14, borderRadius: 18, backgroundColor: C.card },
  ...
  sectionTitle:  { fontFamily: fonts.display, fontSize: fontSize['2xl'], color: C.ink },
  ...
  modalTitle:   { fontFamily: fonts.display, fontSize: fontSize['2xl'], color: C.ink },
